...
import type { TaskAttachmentResponse } from '../../types';
...
export default function TaskAttachments({ projectId, taskId, canUpload, currentUsername, isOwner, showAlert }: Props) {
    ...
    const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            setCollapsed(false);
            load();
            showAlert('Файл прикреплён', 'success');
        } catch (e: any) {
